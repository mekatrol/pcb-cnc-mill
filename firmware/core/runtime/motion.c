...
void start_motion(int32_t x, int32_t y, int32_t z, int32_t a)
{
  ...
  if (dy > motion.steps_remaining)
    motion.steps_remaining = dy;
  if (dz > motion.steps_remaining)
    motion.steps_remaining = dz;
  if (de > motion.steps_remaining)
    motion.steps_remaining = de;
